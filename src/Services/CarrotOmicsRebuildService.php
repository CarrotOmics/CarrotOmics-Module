...
/**
 * Service for handling CarrotOmics's rebuild logic.
 */
class CarrotOmicsRebuildService {
  ...
  /**
   * Constructs a new CarrotOmicsRebuildService object.
   *
  ...
  /**
   * Executes the rebuild process for carrotomics.
   *
